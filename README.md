...
| `MergeSort/Net4.lean` | Part 3 building block, verified: 5-comparator sorting network on four values from branchless selects (`net4_sorted`, `net4_perm` by exhaustive case analysis + `omega`). |
